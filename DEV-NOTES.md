...
> **Last updated:** 2026-05-03, against version **0.30.0**.
...
Built iteratively in one working session (May 2026, started from empty `x:\Projects\VsCodePlugins`). Current shipped version: **0.30.0**.
